...
const buildExactDemoOpening = ({
  ...
  return `Hey! ${timeOfDayGreeting}... this is Aspen, with AIHiddenLeads.com. So glad you're here. Okay — quick question for you: did you know that, statistically, the average American small business misses about six out of every ten phone calls that ring in? Six out of ten! I mean... that's more ghosting than a bad Tinder date, right? And every single one of those missed calls? Yeah — that's a customer who just called your competitor instead. Wild, isn't it? Well, that's literally why I exist. I pick up every call, twenty-four seven, I book the appointments, I reschedule them, and when something really needs a human touch, I transfer the call live — warm handoff, no awkward elevator music. Pretty cool, huh? Alright, here's what we're gonna do — I'll simulate as if I was already working on the ${spokenBusinessName} website, so you can hear exactly how I'd sound for your customers. Totally relaxed, just a quick demo. But first... before we jump in... what should I call you?`;
};
